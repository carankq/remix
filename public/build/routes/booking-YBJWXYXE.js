...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/booking.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1760269126582.5781";
}
function BookingRoute() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Header, {}, void 0, false, {
      fileName: "app/routes/booking.tsx",
      lineNumber: 25,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "container px-4 py-8", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-2xl text-gray-900", children: "Booking" }, void 0, false, {
        fileName: "app/routes/booking.tsx",
        lineNumber: 28,
        columnNumber: 11
      }, this),
...
_c = BookingRoute;
var _c;
$RefreshReg$(_c, "BookingRoute");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  BookingRoute as default
};
//# sourceMappingURL=/build/routes/booking-YBJWXYXE.js.map
