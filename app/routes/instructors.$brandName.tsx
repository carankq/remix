...
export default function InstructorProfilePage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, background: '#f8fafc', paddingTop: '2rem', paddingBottom: '4rem' }}>
        <div style={{
          maxWidth: '1200px',
          margin: '0 auto',
          padding: '0 1rem'
          ...
          <div style={{
            ...
            {/* Profile Content */}
            <div style={{ padding: '5rem 3rem 3rem 3rem' }}>
              {/* Header Section */}
              <div style={{ marginBottom: '2rem' }}>
                <div style={{ display: 'flex', alignItems: 'start', justifyContent: 'space-between', gap: '1.5rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
                  <div style={{ flex: 1 }}>
                    <h1 style={{
                      fontSize: '2.5rem',
                      fontWeight: '700',
                    ...
                    {instructor.company && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                        ...
                        <span style={{ fontSize: '1.125rem', color: '#64748b', fontWeight: '500' }}>{instructor.company}</span>
                      </div>
                    )}
                      ...
                      {hasRating && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                          <div style={{ display: 'flex', gap: '0.125rem' }}>
                            {[...Array(5)].map((_, i) => (
                              <svg key={i} width="20" height="20" viewBox="0 0 24 24" fill={i < Math.floor(instructor.rating!) ? "#f59e0b" : "#e5e7eb"} stroke={i < Math.floor(instructor.rating!) ? "#f59e0b" : "#e5e7eb"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {instructor.pricePerHour && (
                    <div style={{
                      ...
                      <div style={{ fontSize: '3rem', fontWeight: '700', color: '#ffffff', marginBottom: '0.25rem', lineHeight: 1 }}>
                        £{instructor.pricePerHour}
                      </div>
                      <div style={{ fontSize: '0.875rem', color: '#dbeafe', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: '600' }}>
                        per hour
                      </div>
                    </div>
                  )}
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        {instructor.postcode && instructor.postcode.length > 0 && (
                          <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem' }}>
                            ...
                            <div>
                              <div style={{ fontSize: '0.875rem', color: '#64748b', marginBottom: '0.25rem' }}>Coverage Areas</div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {instructor.availability.map((a, i) => (
                          <div key={i} style={{
                            ...
                            <span style={{ fontSize: '0.9375rem', color: '#854d0e' }}>
