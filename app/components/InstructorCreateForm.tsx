        ...
        <div style={{
          ...
          boxShadow: '0 1px 3px rgba(0,0,0,0.05)'
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {ownerInst.company && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
                      ...
                      <span style={{ fontSize: '0.875rem', color: '#64748b' }}>{ownerInst.company}</span>
                    </div>
                  )}
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                      ...
                      <span style={{ fontSize: '0.9375rem', fontWeight: '600', color: '#0f172a' }}>
                        {ownerInst.rating || 'N/A'}
                      </span>
                      <span style={{ fontSize: '0.8125rem', color: '#64748b' }}>
                        ({ownerInst.totalReviews || 0} reviews)
                      </span>
                    </div>
                    {ownerInst.yearsOfExperience && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                        ...
                        <span style={{ fontSize: '0.875rem', color: '#64748b' }}>
                          {ownerInst.yearsOfExperience} years experience
                        </span>
                      </div>
                    )}
                  </div>
            ...
            <div style={{ padding: '0 2rem 2rem 2rem' }}>
              <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <span style={{ fontSize: '0.875rem', fontWeight: '500', color: '#334155' }}>
                    {Array.isArray(ownerInst.postcode) ? ownerInst.postcode.join(', ') : ownerInst.postcode}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span style={{ fontSize: '0.875rem', fontWeight: '500', color: '#334155' }}>
                    {ownerInst.vehicleType}
                  </span>
                </div>
              </div>
              
              {ownerInst.description && (
              ...
              {(ownerInst.specializations && ownerInst.specializations.length > 0) && (
                <div style={{ marginBottom: '1.5rem' }}>
                  <h5 style={{ 
                    fontSize: '0.75rem', 
                    fontWeight: '600', 
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {ownerInst.specializations.map((spec: string, i: number) => (
                      <span key={i} style={{
              ...
              {ownerInst.availability && ownerInst.availability.length > 0 && (
                <div>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {ownerInst.availability.slice(0, 6).map((a: any, i: number) => (
                      <span key={i} style={{
                        padding: '0.5rem 0.875rem',
                        background: '#fef3c7',
                        color: '#78350f',
                        ...
                        {a.day.slice(0, 3)} {a.start || new Date(a.startTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}–{a.end || new Date(a.endTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                      </span>
                    ))}
                    {ownerInst.availability.length > 6 && (
                      <span style={{
                        padding: '0.5rem 0.875rem',
                        background: '#f1f5f9',
                        color: '#64748b',
                        ...
                        +{ownerInst.availability.length - 6} more
                      </span>
                    )}
                  </div>
                </div>
